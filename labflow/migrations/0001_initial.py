# Generated by Django 5.1.7 on 2025-04-30 23:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('informatica', 'Laboratório de Informática'), ('eletronica', 'Laboratório de Eletrônica'), ('sala_aula', 'Sala de Aula')], max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('laboratorio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='labflow.laboratorio')),
            ],
        ),
        migrations.CreateModel(
            name='Equipamento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('laboratorio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='labflow.laboratorio')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='labflow.usuario')),
            ],
        ),
    ]
